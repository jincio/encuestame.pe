...
$featurearray = array("Aplicación" => array("Posta médica","Hospital público (MINSA)","EsSalud","Clínica privada","Laboratorio privado","Aseguradora (Pacífico, Rímac, etc)"),"Origen" => array("Sinopharm","Pfizer-BioNTech","Oxford-Aztrazeneca","Sputnik","Johnson & Johnson"),"Costo" => array("Pagas S/. 50.00","Pagas S/. 20.00","Gratis","Te pagan S/. 20.00","Te pagan S/. 50.00"),"Dosis" => array("1","2","3"));
